...
- Điền đủ nếu muốn mở toàn bộ capability phát hành:
  - `VITE_SUPABASE_URL`
...
- Kiểm tra GitHub secrets:
  ...
  - `ALLOWED_ORIGINS`
  - `PUBLIC_SECURITY_CONTACT`
- Kiểm tra GitHub secrets cho runtime capability:
  - `SUPABASE_URL`
  - `SUPABASE_SERVICE_ROLE_KEY`
  - `RESEND_API_KEY`
  - `RESEND_FROM_EMAIL`
...
- Mở app public và kiểm tra:
  - cloud auth mở đúng
  - lưu/nạp cloud plan hoạt động
  - lead capture không bị disabled
  - executive report gửi được
